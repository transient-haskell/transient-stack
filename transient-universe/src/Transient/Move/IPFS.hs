...
{-# LANGUAGE OverloadedStrings, FlexibleContexts, ScopedTypeVariables, FlexibleInstances, UndecidableInstances #-}
...
-- Store and recover a persistent counter in IPFS and increment it in every execution
-- main= keep' $  do
--     setIPFS
--     id <- genPersistId
